...
@State
public class StampedLockHoldersMap2TokenHolderJcStressTest {
    private AtomicInteger count = new AtomicInteger();

    private _2_TokenHolder tokenHolder = new StampedLockHoldersMap2TokenHolder(key -> {
        count.incrementAndGet();
        return new TokenResponse(key, Instant.MAX);
    }, Clock.systemUTC(), new String[] { "key1", "key2" });
